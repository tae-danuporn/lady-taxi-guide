    ...
    container.innerHTML = places.map(place => {
        ...
        <div class="popular-card" data-id="${place.id}">
            ...
            <div class="popular-card-body">
                ...
                <div class="popular-card-desc" data-th="${escHtml(place.descTh)}" data-en="${escHtml(place.descEn)}">${lang === 'th' ? place.descTh : place.descEn}</div>
                <div class="popular-card-meta">
                    <span data-th="🚗 ${place.driveTime}" data-en="🚗 ${place.driveTimeEn}">
                    ...
                    <span data-th="⏱ ${place.visitDuration}" data-en="⏱ ${place.visitDurationEn}">
